...
- **Supprimer** — la suppression se fait dans l'écran d'édition ; un professionnel est **archivé** (suppression douce), pas définitivement effacé.
...
- **Type** et **Nom** (obligatoire)
- **Adresse** — saisissez un **code postal** dans le champ de recherche et la **commune** se remplit automatiquement ; le pays se choisit dans la liste.
- **Contact** — téléphone, téléphone bureau, e-mail, site web
- **Numéro de TVA** avec le bouton **Récupérer** — voir ci-dessous.
- **Compte bancaire**, **numéro interne**, **langue des documents** (NL/FR) et **remarques**.
