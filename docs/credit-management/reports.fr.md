...
![La fenêtre du rapport Prêteur — dossiers réalisés, avec la description du rapport, les champs Du et Jusqu'au, et les boutons Imprimer et Fermer.](../images/rapporten-periode-fr.png "Vous n'indiquez qu'une période ; le rapport, vous l'avez choisi avec la tuile"){ .volle-breedte }
...
![Le rapport Statut par période sur la date d'acte en pdf : en haut l'en-tête du bureau, en dessous le titre et la période, un diagramme circulaire de la répartition par statut et un tableau indiquant par statut le nombre, le montant du crédit et la commission, avec les totaux en dessous.](../images/rapporten-voorbeeld-fr.png "Chaque rapport porte votre propre en-tête"){ .volle-breedte }
