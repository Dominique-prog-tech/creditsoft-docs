...
![Het venster van het rapport Kredietverstrekker — gerealiseerde dossiers, met de omschrijving van het rapport en de velden Van en Tot en met, en de knoppen Afdrukken en Sluiten.](../images/rapporten-periode.png "U geeft enkel een periode op; het rapport koos u met de tegel"){ .volle-breedte }
...
![Het rapport Status periodiek op aktedatum als pdf: bovenaan het briefhoofd van het kantoor, daaronder de titel en de periode, een cirkeldiagram met de verdeling per status en een tabel met per status het aantal, het kredietbedrag en het commissiebedrag, met de totalen eronder.](../images/rapporten-voorbeeld.png "Elk rapport draagt uw eigen briefhoofd"){ .volle-breedte }
